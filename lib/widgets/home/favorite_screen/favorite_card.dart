...
class FavoriteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      margin: EdgeInsets.only(left: width*0.04,right: width*0.04,top: 10,bottom: 10),
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(onPressed: (){}, child: Text('Open',style: TextStyle(fontSize: width*0.045,color: Colors.black),)),
